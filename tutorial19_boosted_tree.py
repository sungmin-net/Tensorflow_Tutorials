# 210120_https://www.tensorflow.org/tutorials/estimator/boosted_trees
...
def make_input_fn(X, y, n_epochs = None, shuffle = True):
    def input_fn():
        ...
        # For training, cycle thru dataset as many times as need (n_epochs = Noe).
...
# The model will stop training one the specified number of trees is built,
